...
To support your learning, the materials include:

- **Conceptual Explanations:** Clear definitions of key genetic principles.
...
Hands-on tutorials are integrated into the course to help you explore how genetics works in practice. We use R as a "virtual laboratory" to simulate populations and observe genetic change over time.
...
- **Pedigrees & History:** Plotting family trees to understand inbreeding and using coalescent models to look back at ancestral history.

**How to use the code:** 
The R code is provided as a starting point. You are encouraged to run the examples and experiment with different values—such as changing the population size or the strength of selection—to see how the results change.

## Prerequisites

To successfully engage with the material, users should have:
