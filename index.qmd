...
This module introduces the statistical and genetic foundations of genome-wide association studies (GWAS), which aim to identify genetic variants associated with complex traits and diseases. Topics include statistical inference for genetic effects, population structure and relatedness, linkage disequilibrium, and methods for identifying causal variants within associated genomic regions. The course also covers heritability estimation, meta-analysis of genetic studies, inference from GWAS summary statistics, and polygenic risk prediction.

The material is based on lecture notes and exercises developed by [Matti Pirinen](https://www.mv.helsinki.fi/home/mjxpirin/) and includes practical examples for analyzing genomic data using R. The material is distributed under a **CC-BY-SA license**.

[Go to Course →](https://www.mv.helsinki.fi/home/mjxpirin/GWAS_course/)
